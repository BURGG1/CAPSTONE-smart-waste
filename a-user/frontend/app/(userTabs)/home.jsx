        ...
        <SafeAreaView className="flex-1">
            <ScrollView className="flex-1 px-4 py-2">
                ...
                <View className="bg-white rounded-xl p-6 shadow mt-10">
                    ...
                    <FlatList
                        data={RULES.filter(r => r.name.toLowerCase().includes(search.toLowerCase()))}
                        ...
                        renderItem={({ item: r }) => (
                            <View className="flex-1 bg-gray-50 rounded-xl shadow-lg overflow-hidden">
                                <Image source={r.image} className="w-full h-40" resizeMode="cover" />
                                <View className="p-3 gap-1">
                                    <Text className="text-sm font-bold">Rule {r.id}</Text>
